...
let referenceBinaries = [ "FSharp.Implicit.dll" ]
...
let info =
  [ "project-name", "FSharp.Implicit"
    "project-author", "Gaston Cababie"
    "project-summary", "A computation builder that adds support for idiomatic op_Implicit usage"
    "project-github", githubLink
    "project-nuget", "http://nuget.com/packages/FSharp.Implicit" ]
